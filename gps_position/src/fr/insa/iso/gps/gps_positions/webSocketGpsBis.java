...
import fr.insa.iso.gps.gps_positions.decoders.PositionRequestMessageDecoder;
import fr.insa.iso.gps.gps_positions.encoders.PositionsMessageEncoder;
import fr.insa.iso.gps.gps_positions.messages.PositionRequestMessage;

@ServerEndpoint(value = "/websocketgpsbis")
