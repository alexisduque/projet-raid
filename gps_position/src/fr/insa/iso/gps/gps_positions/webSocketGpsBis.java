	  ...
	  public void onMessage(String message, Session session) 
	    throws IOException, InterruptedException {
		    ...
		    System.out.println("Received: " + message);
		  	...
		  	String[] dateString = message.split(",");
		  	
		  	String startdate = dateString[0];
		  	String endate = dateString[1];
			...
			String stringTracks = dbcont.getAllTracks(startdate, endate);
	    ...
	    session.getBasicRemote().sendText(stringTracks);
