    ...
    viewer= new Geoportal.Viewer.Default(
        ...
        OpenLayers.Util.extend({
            ...
            loadTheme: function() {
                ...
                Geoportal.Util.loadCSS(Geoportal._getScriptLocation()+'theme/geoportal3/style.css','__GeoportalBlackCss__','');
                if (OpenLayers.Util.alphaHack()) {
                    Geoportal.Util.loadCSS(OpenLayers._getScriptLocation()+'theme/geoportal3/ie6-style.css','__IE6GeoportalBlackCss__','');
                }
            }
