...
function addmarker(mLon,mLat,width,height,html,open) {
    ...
    pnr.events.register('mousedown', pnr, function(evt) {
        if (this.feature==null) {
            ...
            this.feature.popup.panMapIfOutOfView= false;
            this.feature.popup.autoSize= false;//bug on popup size if true ?!
...
function initMap() {
    ...
    var popupW= 250;
    var popupH= 115;
    var popupContent= "<div style=\"font-weight:bold;font-size:14px\">Institut National de l'information<br/>géographique et forestière</div><br/>"+
                      "73 avenue de Paris<br/>"+
                      "94165 SAINT-MANDÉ<br/>"+
                      "Tél : +33 1 43 98 80 00";
    // Longitude/Latitude map - carte
    var cenLon=  2.412791;
    var cenLat= 48.840419;
    ...
    viewer.addGeoportalLayers(
        ...
        {
            'TRANSPORTNETWORKS.ROADS'     : {opacity:0.80},
    ...
    addmarker(markerLon,markerLat,popupW,popupH,popupContent,true);
}
