...
function createLayer() {
    return new Geoportal.Layer.OpenLS.Core.LocationUtilityService(
        'GeodeticFixedPoint:OPENLS;Geocode',//layer name
        {
...
function createSearchEngine() {
    ...
    var gazetteer= new Geoportal.Control.LocationUtilityService.GeodeticFixedPoint(olsLayer, {
        // force drawLocation
        drawLocation:true,
            ...
            if (this.cntrl.map) {
                ...
                if (t!==this.cntrl.map.baseLayer.territory) {
                    ...
                    if (territoriesViewer[t]==null) {
                        ...
                        this.cntrl= territoriesViewer[t].getMap().getControlsByClass('Geoportal.Control.LocationUtilityService.GeodeticFixedPoint')[0];
                        this.cntrl.activate();
                        currentTerritory= t;
                    }
