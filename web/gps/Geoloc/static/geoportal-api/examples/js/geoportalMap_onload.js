...
function initMap() {
    ...
    alert(OpenLayers.i18n('callback',{'name':'initMap'}));
}

function firstOnLoadCallback() {
    alert('firstOnLoadCallback');
    if (viewer) {
        OpenLayers.Console.error(OpenLayers.i18n('new.instance.already.called'));
        return;
    }
}

function secondOnLoadCallback() {
    alert('secondOnLoadCallback');
    if (viewer) {
        OpenLayers.Console.error(OpenLayers.i18n('new.instance.already.called'));
        return;
    }
